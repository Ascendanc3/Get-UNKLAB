...
class CreatePortfolioProfileWidget extends StatefulWidget {
  const CreatePortfolioProfileWidget({Key key}) : super(key: key);

  @override
  _CreatePortfolioProfileWidgetState createState() =>
      _CreatePortfolioProfileWidgetState();
}

class _CreatePortfolioProfileWidgetState
    extends State<CreatePortfolioProfileWidget> {
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        Expanded(
                          child: Text(
                            'Yuk Keluarkan Hasil Kerjamu Selama Kuliah di UNKLAB',
                  ...
                  children: [
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text(
                            'Anda bisa menambahkan secara manual ',
