    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'studentID':
          ...
          break;
        case 'pointSiswa':
          result.pointSiswa = serializers.deserialize(value,
...
class UsersRecordBuilder implements Builder<UsersRecord, UsersRecordBuilder> {
  ...
  int _pointSiswa;
  int get pointSiswa => _$this._pointSiswa;
  set pointSiswa(int pointSiswa) => _$this._pointSiswa = pointSiswa;
