...
import 'schema/portfolio_student_record.dart';
import 'schema/absensi_scan_record.dart';
...
export 'schema/portfolio_student_record.dart';
export 'schema/absensi_scan_record.dart';
...
/// Functions to query PortfolioStudentRecords (as a Stream and as a Future).
Stream<List<PortfolioStudentRecord>> queryPortfolioStudentRecord(
        {Query Function(Query) queryBuilder,
        int limit = -1,
        bool singleRecord = false}) =>
    queryCollection(
        PortfolioStudentRecord.collection, PortfolioStudentRecord.serializer,
        queryBuilder: queryBuilder, limit: limit, singleRecord: singleRecord);

Future<List<PortfolioStudentRecord>> queryPortfolioStudentRecordOnce(
        {Query Function(Query) queryBuilder,
        int limit = -1,
        bool singleRecord = false}) =>
    queryCollectionOnce(
...
Future<FFFirestorePage<PortfolioStudentRecord>>
    queryPortfolioStudentRecordPage({
  Query Function(Query) queryBuilder,
  DocumentSnapshot nextPageMarker,
  int pageSize,
  bool isStream,
        ...
        queryCollectionPage(
          PortfolioStudentRecord.collection,
...
/// Functions to query AbsensiScanRecords (as a Stream and as a Future).
Stream<List<AbsensiScanRecord>> queryAbsensiScanRecord(
        {Query Function(Query) queryBuilder,
        int limit = -1,
        bool singleRecord = false}) =>
    queryCollection(AbsensiScanRecord.collection, AbsensiScanRecord.serializer,
        queryBuilder: queryBuilder, limit: limit, singleRecord: singleRecord);

Future<List<AbsensiScanRecord>> queryAbsensiScanRecordOnce(
        {Query Function(Query) queryBuilder,
        int limit = -1,
        bool singleRecord = false}) =>
    queryCollectionOnce(
        AbsensiScanRecord.collection, AbsensiScanRecord.serializer,
        queryBuilder: queryBuilder, limit: limit, singleRecord: singleRecord);

Future<FFFirestorePage<AbsensiScanRecord>> queryAbsensiScanRecordPage({
  Query Function(Query) queryBuilder,
  DocumentSnapshot nextPageMarker,
  int pageSize,
  bool isStream,
